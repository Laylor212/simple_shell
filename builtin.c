...
int shellby_cd(cgar **args, char __attribute__((__unused__)) **front);
 ...
 * Description: Upon returning -3, the proram exits back in the main function
 */int shellby_exit(char **args, char **front)
{
	int i, len_of_int = 10;
...
/**
 * shellby_cd - Changes the current directory of the shell process
 ...
 *	Otherwise - 0
 */
int shellby_cd(char **agrs, char __attribute__((__unused__)) **front)
{
...
/**
 * shellby_help - Displays information about shell builtin commands
 * @args: an array of arguments
